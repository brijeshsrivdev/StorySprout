...
| Story Outline | IMPLEMENTED | `docs/specifications/story-outline.md` | `docs/features/story-outline/implementation.md` | Backend unit/integration, frontend duration unit, Playwright E2E | Existing Story Creation, Spring AI/Gemini infrastructure, PostgreSQL, Next.js |
