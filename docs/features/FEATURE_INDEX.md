...
| Editor | SPECIFIED | `docs/specifications/editor.md` + `docs/specifications/editor-clarifications.md` | — | 31 acceptance criteria and test cases specified; implementation not started | Scene Setup, Characters, Story Outline, future Composition schema 1.1 |
