...
| Story Outline | VALIDATED | `docs/specifications/story-outline.md` | `docs/features/story-outline/implementation.md` | Frontend unit, backend unit/integration, PostgreSQL/Testcontainers, Playwright E2E; full CI validation passed | Existing Story Creation, Spring AI/Gemini infrastructure, PostgreSQL, Next.js |
| Characters | SPECIFIED | `docs/specifications/characters.md` | Not started | Test scenarios defined in specification | Existing Story Outline, Story Creation, Spring AI/Gemini infrastructure, PostgreSQL, Next.js |
