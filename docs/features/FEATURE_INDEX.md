...
| Editor | IN_PROGRESS | `docs/specifications/editor.md` + `docs/specifications/editor-clarifications.md` | `docs/features/editor/implementation.md` | Model regression, backend service tests, Scene Setup → Editor Playwright flow; full CI pending | Scene Setup, Characters, Story Outline, Composition schema 1.1, PostgreSQL, Next.js |
