...
public class CompositionRepository {
    ...
    @Autowired
    public CompositionRepository(JdbcTemplate jdbc,ObjectMapper mapper){this.jdbc=jdbc;this.mapper=mapper!=null?mapper:new ObjectMapper();}
    public CompositionRepository(JdbcTemplate jdbc){this(jdbc,new ObjectMapper());}
