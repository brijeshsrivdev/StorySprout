...
export default function CreateStoryPage() {
  ...
  return <main className="min-h-screen bg-slate-50"><div className="mx-auto max-w-4xl px-8 py-12"><a href="/" className="text-sm font-medium text-slate-500 hover:text-slate-900">← Dashboard</a><div className="mt-10"><p className="text-sm font-semibold text-indigo-600">NEW STORY</p><h1 className="mt-2 text-4xl font-bold">How would you like to start?</h1><p className="mt-3 text-slate-600">Choose a starting point. You can shape the story as you go.</p></div>
